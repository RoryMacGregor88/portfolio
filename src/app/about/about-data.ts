...
export const ABOUT_DATA: AboutData = [
  ...
  relatively comfortable with a Windows Powershell.`,
      ...
      `After a period of self-learning and research into the landscape of software engineering, I attended CodeClan in Edinburgh, which allowed me to study the fundamentals of full-stack development and agile methodology that would prepare me for working within the dev team of a professional tech firm.`,
      `I was hired as a junior dev at Astrosat in 2019 and spent the next nearly 4 years learning from the seniors there, eventually being promoted to mid-level, assigned large features, and leading teams of up to three developers.`,
    ],
  },
  {
